...
import { ACCUEIL, MUSIQUE, SPORTS, VISIONNER } from '../assistants/routes.js'; //Importer les constantes des path ici. Comme ça, il faut le modifier à un seul endroit.
import TopNavbar from './reutilisables/TopNavbar.js';
import HomePage from './sections/Accueil/Accueil.js'; //Importer le component HomePage pour l'utiliser.
